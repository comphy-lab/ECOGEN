...
class CellO2Cartesian : public CellO2
{
  public:
    ...
    //Pour methode AMR
    void createChildCell(const int& lvl) override; /*!< Creer une cell enfant (non initializee) */

    //Pour methodes ordre 2 parallele
    void getBufferSlopes(double* /*buffer*/, int& /*counter*/, const int& /*lvl*/) override
    {
      Errors::errorMessage("getBufferSlopes not available for CellO2Cartesian");
    };
