...
class Element
{
  public:
    ...
    {
      Errors::errorMessage("getIndex not available for requested element");
    ...
    {
      Errors::errorMessage("setPos not available for requested element");
    };
    ...
    {
      Errors::errorMessage("setSize not available for requested element");
    };
    ...
    {
      Errors::errorMessage("getSizeX not available for requested element");
      return Errors::defaultDouble;
    };
    virtual const double& getSizeY()
    {
      Errors::errorMessage("getSizeY not available for requested element");
      return Errors::defaultDouble;
    };
    virtual const double& getSizeZ()
    {
      Errors::errorMessage("getSizeZ not available for requested element");
      return Errors::defaultDouble;
    };
    virtual const Coord& getSize()
    {
      Errors::errorMessage("getSize not available for requested element");
    ...
    {
      Errors::errorMessage("getElementChild not available for requested element");
      return 0;
    };
