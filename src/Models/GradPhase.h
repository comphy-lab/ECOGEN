...
class GradPhase
{
  public:
    ...
    {
      Errors::errorMessage("computeDistanceGradientScalarProduct not available for required GradPhase");
    };
    ...
    {
      Errors::errorMessage("numberOfTransmittedGradients not available for required GradPhase");
