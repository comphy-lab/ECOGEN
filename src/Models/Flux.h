...
class Flux
{
  public:
    ...
    {
      Errors::errorMessage("subtractFluxRotatingRegion not available for required model");
    };
    ...
    {
      Errors::errorMessage("addNonCons not available for required model");
    };
    ...
    {
      Errors::errorMessage("subtractNonCons not available for required model");
    };
    ...
    {
      Errors::errorMessage("addSymmetricTerms not implemented for used model");
    };
    ...
    {
      Errors::errorMessage("prepSourceTermsMRF not available for required model");
    };
    //! \brief     This prepares Plane-Gaussian-pulse and Plane-Sinusoidal-pulse source terms
    virtual void prepSourceTermsPlaneWave(const Cell* /*cell*/, const double& /*sourceMomentum*/, const Coord& /*pulseDirection*/)
    {
      Errors::errorMessage("prepSourceTermsPlaneWave not available for required model");
    };
    ...
    {
      Errors::errorMessage("addFluxSmooth1D not available for required model");
    };
    ...
    {
      Errors::errorMessage("substractFluxSmooth1D not available for required model");
    };
    ...
    {
      Errors::errorMessage("getAlpha not available for required model");
      return Errors::defaultDouble;
    };
    virtual const double& getMass(const int& /*numPhase*/) const
    {
      Errors::errorMessage("getMass not available for required model");
      return Errors::defaultDouble;
    };
    virtual const double& getEnergyMix() const
    {
      Errors::errorMessage("getEnergyMix not available for required model");
      return Errors::defaultDouble;
    };
    virtual const double& getMassMix() const
    {
      Errors::errorMessage("getMassMix not available for required model");
      return Errors::defaultDouble;
    };
    virtual const double& getEqOmega() const
    {
      Errors::errorMessage("getEqOmega not available for required model");
      return Errors::defaultDouble;
    };
    virtual const double& getEqEta() const
    {
      Errors::errorMessage("getEqEta not available for required model");
      return Errors::defaultDouble;
    };
    virtual const double& getEnergy(const int& /*numPhase*/) const
    {
      Errors::errorMessage("getEnergy not available for required model");
      return Errors::defaultDouble;
    };
    virtual const double& getTotEnergy(const int& /*numPhase*/) const
    {
      Errors::errorMessage("getTotEnergy not available for required model");
      return Errors::defaultDouble;
    };
    virtual const double& getLambda(const int& /*numPhase*/) const
    {
      Errors::errorMessage("getLambda not available for required model");
      return Errors::defaultDouble;
    };
    virtual const Tensor& getCobase(const int& /*numPhase*/) const
    {
      Errors::errorMessage("getCobase not available for required model");
      return Tensor::defaultTensor;
    };
    virtual const Coord& getMomentum() const
    {
      Errors::errorMessage("getMomentum not available for required model");
      return Coord::defaultCoord;
    };
    virtual const Coord& getMomentum(const int& /*numPhase*/) const
    {
      Errors::errorMessage("getMomentum not available for required model");
      return Coord::defaultCoord;
    };
    ...
    {
      Errors::errorMessage("getEqVectorP not available for required model");
      return Coord::defaultCoord;
    };
