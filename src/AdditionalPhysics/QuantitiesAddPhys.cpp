...
QuantitiesAddPhys::QuantitiesAddPhys(AddPhys* addPhys) : m_addPhys(addPhys) {}
...
double QuantitiesAddPhys::computeEnergyAddPhys() { return m_addPhys->computeEnergyAddPhys(this); }
