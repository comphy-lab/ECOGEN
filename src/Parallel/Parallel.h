...
class Parallel
{
  public:
    ...
    void initializePersistentCommunications(const int& numberPrimitiveVariables,
    ...
    void initializePersistentCommunicationsAMR(
    ...
    void initializePersistentCommunicationsFromLvl0AMR(const int& lvlMax);
    ...
    void initializePersistentCommunicationsXi(const int& lvl, const int& number);
    void finalizePersistentCommunicationsXi(const int& lvlMax);
    void communicationsXi(int lvl);

    void initializePersistentCommunicationsSplit(const int& lvl, const int& number);
