...
ModEulerHomogeneous::~ModEulerHomogeneous() { delete fluxBuff; }

//****************************************************************************

void ModEulerHomogeneous::allocateCons(Flux** cons) { *cons = new FluxEulerHomogeneous(); }

//***********************************************************************

void ModEulerHomogeneous::allocatePhase(Phase** phase) { *phase = new PhaseEulerHomogeneous; }

//***********************************************************************

void ModEulerHomogeneous::allocateMixture(Mixture** mixture) { *mixture = new MixEulerHomogeneous; }

//***********************************************************************

void ModEulerHomogeneous::allocatePhaseGradient(GradPhase** phase) { *phase = new GradPhaseEulerHomogeneous; }

//***********************************************************************

void ModEulerHomogeneous::allocateMixtureGradient(GradMixture** mixture) { *mixture = new GradMixEulerHomogeneous; }
...
void ModEulerHomogeneous::solveRiemannIntern(
...
const double& ModEulerHomogeneous::getSM() { return static_cast<FluxEulerHomogeneous*>(fluxBuff)->m_sM; }
...
int ModEulerHomogeneous::getLiq() { return m_liq; }

//****************************************************************************

int ModEulerHomogeneous::getVap() { return m_vap; }
