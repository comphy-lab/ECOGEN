...
class Phase
{
  public:
    ...
    virtual void extendedCalculusPhase(const Coord& /*velocity*/ = Errors::defaultDouble)
    {
      Errors::errorMessage("extendedCalculusPhase not available for requested phase type");
    };

    virtual void computeMassFraction(const double& /*density*/)
    {
      Errors::errorMessage("computeMassFraction not available for requested phase type");
    };

    virtual void localProjection(const Coord& /*normal*/, const Coord& /*tangent*/, const Coord& /*binormal*/)
    {
      Errors::errorMessage("projection not available for requested phase type");
    };
    virtual void reverseProjection(const Coord& /*normal*/, const Coord& /*tangent*/, const Coord& /*binormal*/)
    {
      Errors::errorMessage("reverseProjection not available for requested phase type");
    };
    ...
    {
      Errors::errorMessage("getNumberScalars not available for requested phase type");
      return 0;
    };
    virtual int getNumberVectors() const
    {
      Errors::errorMessage("getNumberVectors not available for requested phase type");
      return 0;
    };
    virtual double returnScalar(const int& /*numVar*/) const
    {
      Errors::errorMessage("returnScalar not available for requested phase type");
      return 0.;
    };
    virtual Coord returnVector(const int& /*numVar*/) const
    {
      Errors::errorMessage("returnVector not available for requested phase type");
      return 0;
    };
    virtual std::string returnNameScalar(const int& /*numVar*/) const
    {
      Errors::errorMessage("returnNameScalar not available for requested phase type");
      return 0;
    };
    virtual std::string returnNameVector(const int& /*numVar*/) const
    {
      Errors::errorMessage("returnNameVector not available for requested phase type");
      return 0;
    };
    ...
    {
      Errors::errorMessage("setScalar not available for requested phase type");
    };
    virtual void setVector(const int& /*numVar*/, const Coord& /*value*/)
    {
      Errors::errorMessage("setVector not available for requested phase type");
    };
    ...
    {
      Errors::errorMessage("numberOfTransmittedVariables not available for requested phase type");
      return 0;
    };
    virtual void fillBuffer(double* /*buffer*/, int& /*counter*/) const
    {
      Errors::errorMessage("fillBuffer not available for requested phase type");
    };
    ...
    {
      Errors::errorMessage("getBuffer not available for requested phase type");
    };
    ...
    {
      Errors::errorMessage("computeSlopesPhase not available for requested phase type");
    };
    ...
    {
      Errors::errorMessage("extrapolate not available for requested phase type");
    };
    virtual void
    limitSlopes(const Phase& /*slopeGauche*/, const Phase& /*slopeDroite*/, Limiter& /*globalLimiter*/, Limiter& /*volumeFractionLimiter*/)
    {
      Errors::errorMessage("limitSlopes not available for requested phase type");
    };
    ...
    virtual void computeGradientLimiter(
      const Limiter& /*globalLimiter*/, const Phase& /*phase*/, const Phase& /*phaseMin*/, const Phase& /*phaseMax*/, const Phase& /*slope*/)
    {
      Errors::errorMessage("computeGradientLimiter not available for requested phase type");
    };
    ...
    {
      Errors::errorMessage("numberOfTransmittedSlopes not available for requested phase type");
      return 0;
    };
    virtual void fillBufferSlopes(double* /*buffer*/, int& /*counter*/) const
    {
      Errors::errorMessage("fillBufferSlopes not available for requested phase type");
    };
    virtual void getBufferSlopes(double* /*buffer*/, int& /*counter*/)
    {
      Errors::errorMessage("getBufferSlopes not available for requested phase type");
    };
    ...
    {
      Errors::errorMessage("getSquareLongitudinalWaveSpeed not available for requested phase type");
    ...
    {
      Errors::errorMessage("verifyPhase not available for requested phase type");
    };
    ...
    {
      Errors::errorMessage("verifyAndCorrectDensityMax not available for requested phase type");
    };
    ...
    {
      Errors::errorMessage("getAlpha not available for requested phase type");
      return Errors::defaultDouble;
    };
    virtual const double& getMassFraction() const
    {
      Errors::errorMessage("getMassFraction not available for requested phase type");
      return Errors::defaultDouble;
    };
    ...
    {
      Errors::errorMessage("getEta not available for requested phase type");
      return Errors::defaultDouble;
    };
    virtual const double& getPressure() const
    {
      Errors::errorMessage("getPressure not available for requested phase type");
      return Errors::defaultDouble;
    };
    virtual const double& getY() const
    {
      Errors::errorMessage("getY not available for requested phase type");
      return Errors::defaultDouble;
    };
    virtual const double& getU() const
    {
      Errors::errorMessage("getU not available for requested phase type");
      return Errors::defaultDouble;
    };
    virtual const double& getV() const
    {
      Errors::errorMessage("getV not available for requested phase type");
      return Errors::defaultDouble;
    };
    virtual const double& getW() const
    {
      Errors::errorMessage("getW not available for requested phase type");
      return Errors::defaultDouble;
    };
    virtual Coord& getVelocity()
    {
      Errors::errorMessage("getVelocity not available for requested phase type");
    ...
    {
      Errors::errorMessage("getVectorPX not available for requested phase type");
      return Errors::defaultDouble;
    };
    virtual const double& getVectorPY() const
    {
      Errors::errorMessage("getVectorPY not available for requested phase type");
      return Errors::defaultDouble;
    };
    virtual const double& getVectorPZ() const
    {
      Errors::errorMessage("getVectorPZ not available for requested phase type");
      return Errors::defaultDouble;
    };
    virtual Coord& getVectorP()
    {
      Errors::errorMessage("getVectorP not available for requested phase type");
      return Coord::defaultCoordNonConst;
    };
    ...
    {
      Errors::errorMessage("EOS not available for requested phase type");
      return 0;
    };
    virtual const double& getEnergy() const
    {
      Errors::errorMessage("getEnergy impossible avec type de phase demande");
      return Errors::defaultDouble;
    };
    virtual const double& getSoundSpeed() const
    {
      Errors::errorMessage("getSoundSpeed impossible avec type de phase demande");
      return Errors::defaultDouble;
    };
    virtual const double& getTotalEnergy() const
    {
      Errors::errorMessage("getTotalEnergy impossible avec type de phase demande");
      return Errors::defaultDouble;
    };
    virtual double getTemperature() const
    {
      Errors::errorMessage("getT impossible avec type de phase demande");
      return 0.;
    };
    virtual const double& getLambda() const
    {
      Errors::errorMessage("getLambda not available for requested phase type");
      return Errors::defaultDouble;
    };
    virtual const double& getEnergyCompaction() const
    {
      Errors::errorMessage("getEnergyCompaction not available for requested phase type");
      return Errors::defaultDouble;
    };
    virtual const Tensor& getCobase() const
    {
      Errors::errorMessage("getCobase not available for requested phase type");
    ...
    {
      Errors::errorMessage("getEnergyElastic not available for requested phase type");
      return Errors::defaultDouble;
    };
    virtual const Tensor& getStressTensor() const
    {
      Errors::errorMessage("getStressTensor not available for requested phase type");
      return Tensor::defaultTensor;
    };
    ...
    {
      Errors::errorMessage("setVelocity not available for requested phase type");
    };
    ...
    virtual void setVectorP(const double& /*x*/, const double& /*y*/, const double& /*z*/)
    {
      Errors::errorMessage("setVector not available for requested phase type");
    };
    ...
    virtual void setTotalEnergy(const double& /*energy*/, const Coord& /*vel*/)
    {
      Errors::errorMessage("setTotalEnergy not available for requested phase type");
    };
    ...
    virtual void setEnergyCompaction(double /*energyCompaction*/)
    {
      Errors::errorMessage("setEnergyCompaction not available for requested phase type");
    };
    ...
    {
      Errors::errorMessage("multiplyAndAdd not available for requested phase type");
    };
