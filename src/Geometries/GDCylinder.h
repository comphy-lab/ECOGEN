...
#define ECOGEN_CYLINDER_DIMENSION 3 // For convenience purpose: a cylinder is always 3D

//! \class     GDCylinder
//! \brief     Class describing a cylinder geometrical domain
class GDCylinder : public GeometricalDomain
{
  public:
    ...
    bool belong(Coord& posElement, const int& /*lvl*/) const override;
  ...
  private:
    ...
    Axis m_axes[ECOGEN_CYLINDER_DIMENSION]; //!< Array storing the cylinder main axes for axes travel in loops.
};
