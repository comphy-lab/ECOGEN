...
FaceSegment::FaceSegment(const int& numNode1, const int& numNode2, int tri) : FaceNS(NUMBERNODES)
{
...
void FaceSegment::computeRepere(const Coord* nodes, const int& numNodeOther, ElementNS* elementNeighbor)
{
  ...
  Coord v2;
  v2.setFromSubtractedVectors(nodes[m_numNodes[0]], nodes[numNodeOther]);
