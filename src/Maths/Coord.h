...
class Coord
{
  public:
    ...
    //! \brief     Scalar product between the present vector and a tensor t
    //! \param     t                    tensor (tensor)
    ...
    //! \brief     Build relative velocity from absolute one (relevant with MRF only)
