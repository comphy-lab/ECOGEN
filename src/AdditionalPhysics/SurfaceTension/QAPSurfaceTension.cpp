...
void QAPSurfaceTension::computeQuantities(Cell* cell) { cell->computeGradients(m_gradC, variableNameSurfTens, numPhaseSurfTens); }

//***********************************************************************

void QAPSurfaceTension::setGrad(const Coord& grad, const int& /*num*/) { m_gradC[0] = grad; }
