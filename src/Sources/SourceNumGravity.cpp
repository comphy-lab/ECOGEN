...
SourceNumGravity::SourceNumGravity(XMLElement* element, int order, int physicalEntity, std::string fileName) : SourceNum(order, physicalEntity)
{
...
void SourceNumGravity::prepSourceTerms(Cell* /*cell*/, const int& i) { sourceCons[i]->prepSourceTermsGravity(m_g); }
