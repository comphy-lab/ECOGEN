...
void ModUEqTotEnergy::allocateCons(Flux** cons) { *cons = new FluxUEqTotEnergy(numberPhases); }

//***********************************************************************

void ModUEqTotEnergy::allocatePhase(Phase** phase) { *phase = new PhaseUEqTotEnergy; }

//***********************************************************************

void ModUEqTotEnergy::allocateMixture(Mixture** mixture) { *mixture = new MixUEqTotEnergy; }
...
void ModUEqTotEnergy::solveRiemannIntern(
  Cell& cellLeft, Cell& cellRight, const double& dxLeft, const double& dxRight, double& dtMax, std::vector<double>& boundData) const
{
  ...
  if (sL >= 0.) {
    for (int k = 0; k < numberPhases; k++) {
      ...
      double energie  = phase->getTotalEnergy();
...
const double& ModUEqTotEnergy::getSM() { return static_cast<FluxUEqTotEnergy*>(fluxBuff)->m_sM; }
