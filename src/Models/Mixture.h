...
class Mixture
{
  public:
    ...
    {
      Errors::errorMessage("allocateAndCopyMixture not available for requested mixture");
    };
    ...
    {
      Errors::errorMessage("computeDensity not available for requested mixture");
      return 0.;
    };
    ...
    {
      Errors::errorMessage("computePressure not available for requested mixture");
      return 0.;
    };
    ...
    virtual double computePressure(
      double /*mass*/, const double& /*internalEnergy*/, Phase** /*phases*/, Mixture* /*mixture*/, const int& /*liq*/, const int& /*vap*/)
    {
      Errors::errorMessage("computePressure not available for requested mixture");
      return 0.;
    };
    //! \brief     Compute mixture velocity
    //! \param     Yk                 phase mass fraction array
    //! \param     ek                 phase velocity array
    //! \return    mixture velocity
    virtual double computeVelocity(const double* /*Yk*/, const double* /*uk*/)
    {
      Errors::errorMessage("computeVelocity not available for requested mixture");
      return 0.;
    };
    virtual double computeTemperature(double* /*masses*/, const double& /*pressure*/, Phase** /*phases*/)
    {
      Errors::errorMessage("computeTemperature not available for requested mixture");
      return 0.;
    };
    ...
    {
      Errors::errorMessage("computeInternalEnergy not available for requested mixture");
      return 0.;
    };
    ...
    {
      Errors::errorMessage("computeFrozenSoundSpeed not available for requested mixture");
      return 0.;
    };
    ...
    virtual double computeTemperatureIsentrope(
      const std::vector<double>& /*Yk*/, const double& /*p0*/, const double& /*T0*/, const double& /*p*/, double* /*dTdp*/ = 0)
    {
      Errors::errorMessage("computeTemperatureIsentrope not available for requested mixture");
      return 0.;
    };
    ...
    virtual double
    computeEnthalpyIsentrope(const std::vector<double>& /*Yk*/, const double& /*p0*/, const double& /*T0*/, const double& /*p*/, double* /*dhdp*/ = 0)
    {
      Errors::errorMessage("computeEnthalpyIsentrope not available for requested mixture");
      return 0.;
    };
    ...
    virtual double
    computeVolumeIsentrope(const std::vector<double>& /*Yk*/, const double& /*p0*/, const double& /*T0*/, const double& /*p*/, double* /*dvdp*/ = 0)
    {
      Errors::errorMessage("computeVolumeIsentrope not available for requested mixture");
      return 0.;
    };
    ...
    {
      Errors::errorMessage("computeMixtureVariables not available for requested mixture");
    };
    ...
    {
      Errors::errorMessage("internalEnergyToTotalEnergy not available for requested mixture");
    };
    ...
    {
      Errors::errorMessage("totalEnergyToInternalEnergy not available for requested mixture");
    };
    ...
    {
      Errors::errorMessage("localProjection not available for requested mixture");
    };
    ...
    {
      Errors::errorMessage("reverseProjection not available for requested mixture");
    };
    ...
    {
      Errors::errorMessage("getNumberScalars not available for requested mixture");
      return 0;
    };
    virtual int getNumberVectors() const
    {
      Errors::errorMessage("getNumberVectors not available for requested mixture");
      return 0;
    };
    virtual double returnScalar(const int& /*numVar*/) const
    {
      Errors::errorMessage("returnScalar not available for requested mixture");
      return 0.;
    };
    virtual Coord returnVector(const int& /*numVar*/) const
    {
      Errors::errorMessage("returnVector not available for requested mixture");
      return 0;
    };
    virtual std::string returnNameScalar(const int& /*numVar*/) const
    {
      Errors::errorMessage("returnNameScalar not available for requested mixture");
      return 0;
    };
    virtual std::string returnNameVector(const int& /*numVar*/) const
    {
      Errors::errorMessage("returnNameVector not available for requested mixture");
      return 0;
    };
    ...
    {
      Errors::errorMessage("setScalar not available for requested mixture type");
    };
    virtual void setVector(const int& /*numVar*/, const Coord& /*value*/)
    {
      Errors::errorMessage("setVector not available for requested mixture type");
    };
    ...
    {
      Errors::errorMessage("numberOfTransmittedVariables not available for requested mixture type");
      return 0;
    };
    virtual void fillBuffer(double* /*buffer*/, int& /*counter*/) const
    {
      Errors::errorMessage("fillBuffer not available for requested mixture type");
    };
    ...
    {
      Errors::errorMessage("getBuffer not available for requested mixture type");
    };
    ...
    {
      Errors::errorMessage("computeSlopesMixture non implemente pour mixture utilise");
    };
    ...
    {
      Errors::errorMessage("extrapolate non implemente pour mixture utilise");
    };
    virtual void limitSlopes(const Mixture& /*slopeGauche*/, const Mixture& /*slopeDroite*/, Limiter& /*globalLimiter*/)
    {
      Errors::errorMessage("limitSlopes non implemente pour mixture utilise");
    };
    virtual void setMin(const Mixture& /*mixture1*/, const Mixture& /*mixture2*/)
    {
      Errors::errorMessage("setMin not available for requested mixture type");
    };
    virtual void setMax(const Mixture& /*mixture1*/, const Mixture& /*mixture2*/)
    {
      Errors::errorMessage("setMax not available for requested mixture type");
    };
    virtual void computeGradientLimiter(const Limiter& /*globalLimiter*/,
                                        const Mixture& /*mixture*/,
                                        const Mixture& /*mixtureMin*/,
                                        const Mixture& /*mixtureMax*/,
                                        const Mixture& /*slope*/)
    {
      Errors::errorMessage("computeGradientLimiter not available for requested mixture type");
    };
    ...
    {
      Errors::errorMessage("numberOfTransmittedSlopes not available for requested mixture");
      return 0;
    };
    virtual void fillBufferSlopes(double* /*buffer*/, int& /*counter*/) const
    {
      Errors::errorMessage("fillBufferSlopes not available for requested mixture");
    };
    virtual void getBufferSlopes(double* /*buffer*/, int& /*counter*/)
    {
      Errors::errorMessage("getBufferSlopes not available for requested mixture");
    };
    ...
    {
      Errors::errorMessage("getDensity not available for requested mixture");
      return Errors::defaultDouble;
    };
    virtual const double& getPressure() const
    {
      Errors::errorMessage("getPressure not available for requested mixture");
      return Errors::defaultDouble;
    };
    virtual const double& getTemperature() const
    {
      Errors::errorMessage("getTemperature not available for requested mixture");
      return Errors::defaultDouble;
    };
    virtual const double& getU() const
    {
      Errors::errorMessage("getU not available for requested mixture");
      return Errors::defaultDouble;
    };
    virtual const double& getV() const
    {
      Errors::errorMessage("getV not available for requested mixture");
      return Errors::defaultDouble;
    };
    virtual const double& getW() const
    {
      Errors::errorMessage("getW not available for requested mixture");
      return Errors::defaultDouble;
    };
    virtual const Coord& getVelocity() const
    {
      Errors::errorMessage("getVelocity not available for requested mixture");
    ...
    {
      Errors::errorMessage("getEnergy not available for requested mixture");
      return Errors::defaultDouble;
    };
    virtual const double& getTotalEnergy() const
    {
      Errors::errorMessage("getTotalEnergy not available for requested mixture");
      return Errors::defaultDouble;
    };
    virtual const double& getFrozenSoundSpeed() const
    {
      Errors::errorMessage("getFrozenSoundSpeed not available for requested mixture");
      return Errors::defaultDouble;
    };
    virtual const double& getWoodSoundSpeed() const
    {
      Errors::errorMessage("getWoodSoundSpeed not available for requested mixture");
      return Errors::defaultDouble;
    };
    virtual const double& getMixSoundSpeed() const
    {
      Errors::errorMessage("getMixSoundSpeed not available for requested mixture");
      return Errors::defaultDouble;
    };
    virtual const double& getEnergyCompaction() const
    {
      Errors::errorMessage("getEnergyCompaction not available for requested mixture");
      return Errors::defaultDouble;
    };
    virtual const double& getEnergyElastic() const
    {
      Errors::errorMessage("getEnergyElastic not available for requested mixture");
      return Errors::defaultDouble;
    };
    virtual const Tensor& getStressTensor() const
    {
      Errors::errorMessage("getStressTensor not available for requested mixture");
      return Tensor::defaultTensor;
    };
    virtual Tensor& getStressTensor()
    {
      Errors::errorMessage("getStressTensor not available for requested mixture");
      return Tensor::defaultTensorNonConst;
    };
    ...
    {
      Errors::errorMessage("setVelocity not available for requested mixture");
    };
    ...
    virtual void setEnergyCompaction(const double& /*energyCompaction*/)
    {
      Errors::errorMessage("setEnergyCompaction not available for requested mixture");
    };
    ...
    {
      Errors::errorMessage("multiplyAndAdd not available for requested mixture");
    };
