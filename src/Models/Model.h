...
class Model
{
  public:
    ...
    //! \param     phase          phase to instanciate
    virtual void allocatePhaseSolidGradient(GradPhase** /*phase*/)
    {
      Errors::errorMessage("allocatePhaseSolidGradient not available for required model");
    };
    ...
    {
      Errors::errorMessage("allocateMixtureGradient not available for required model");
    };
    ...
    //! \brief     Complete some variables if necessary when resuming a simulation
    //! \param     phases         phases array variables
    //! \param     mixture        mixture variables
    virtual void fulfillStateResume(Phase** /*phases*/, Mixture* /*mixture*/)
    {
      Errors::errorMessage("fulfillStateResume not available for required model");
    };
    ...
    {
      Errors::errorMessage("initializeAugmentedVariables not available for required model");
    };
    ...
    virtual void solveRiemannIntern(Cell& /*cellLeft*/,
                                    Cell& /*cellRight*/,
                                    const double& /*dxLeft*/,
                                    const double& /*dxRight*/,
                                    double& /*dtMax*/,
                                    std::vector<double>& /*boundData*/ = DEFAULT_VEC_INTERFACE_DATA) const
    {
      Errors::errorMessage("solveRiemannIntern not available for required model");
    };
    ...
    virtual void solveRiemannInternMRF(Cell& /*cellLeft*/,
                                       Cell& /*cellRight*/,
                                       const double& /*dxLeft*/,
                                       const double& /*dxRight*/,
                                       double& /*dtMax*/,
    ...
    {
      Errors::errorMessage("solveRiemannInternMRF not available for required model");
    };
    ...
    {
      Errors::errorMessage("solveRiemannWall not available for required model");
    };
    ...
    virtual void solveRiemannPiston(
      Cell& /*cellLeft*/, const double& /*dxLeft*/, double& /*dtMax*/, std::vector<double>& /*boundData*/, const double& /*uPiston*/) const
    {
      Errors::errorMessage("solveRiemannPiston not available for required model");
    };
    ...
    //! \param     boundData         boundary dataset used for output
    virtual void solveRiemannInletTank(Cell& /*cellLeft*/,
                                       const double& /*dxLeft*/,
                                       double& /*dtMax*/,
                                       const double* /*ak0*/,
                                       const double* /*rhok0*/,
                                       const double& /*p0*/,
                                       const double& /*T0*/,
                                       std::vector<double>& /*boundData*/) const
    {
      Errors::errorMessage("solveRiemannInletTank not available for required model");
    };
    ...
    //! \param     boundData         boundary dataset used for output
    virtual void solveRiemannInletInjStagState(Cell& /*cellLeft*/,
                                               const double& /*dxLeft*/,
                                               double& /*dtMax*/,
                                               const double /*m0*/,
                                               const double* /*ak0*/,
                                               ...
                                               std::vector<double>& /*boundData*/) const
    {
      Errors::errorMessage("solveRiemannInletInjStagState not available for required model");
    };
    ...
    //! \param     boundData         boundary dataset used for output
    virtual void solveRiemannInletInjTemp(Cell& /*cellLeft*/,
                                          const double& /*dxLeft*/,
                                          double& /*dtMax*/,
                                          const double /*m0*/,
                                          const double* /*Tk0*/,
                                          ...
                                          std::vector<double>& /*boundData*/) const
    {
      Errors::errorMessage("solveRiemannInletInjTemp not available for required model");
    };
    ...
    //! \param     boundData         boundary dataset used for output
    virtual void solveRiemannOutletPressure(
      Cell& /*cellLeft*/, const double& /*dxLeft*/, double& /*dtMax*/, const double /*p0*/, std::vector<double>& /*boundData*/) const
    {
      Errors::errorMessage("solveRiemannOutletPressure not available for required model");
    };
    ...
    //! \param     m0                specific mass flow rate (kg.s-1.m-2)
    //! \param     boundData         boundary dataset used for output
    virtual void solveRiemannOutletMassflow(
      Cell& /*cellLeft*/, const double& /*dxLeft*/, double& /*dtMax*/, const double /*m0*/, std::vector<double>& /*boundData*/) const
    {
      Errors::errorMessage("solveRiemannOutletMassflow not available for required model");
    };
    ...
    {
      Errors::errorMessage("solveRiemannTransportIntern not available for required model");
    };
    ...
    {
      Errors::errorMessage("solveRiemannTransportPiston not available for required model");
    };
    ...
    {
      Errors::errorMessage("solveRiemannTransportInletInjStagState not available for required model");
    };
    ...
    {
      Errors::errorMessage("solveRiemannTransportInletTank not available for required model");
    };
    ...
    virtual void solveRiemannTransportOutletPressure(Cell& /*cellLeft*/, double* /*valueTransports*/)
    {
      Errors::errorMessage("solveRiemannTransportOutletPressure not available for required model");
    };
    ...
    {
      Errors::errorMessage("reverseProjection not available for required model");
    };

    //Relaxations
    //-----------
    //! \brief     Run all the relaxations
    //! \param     cell              cell
    //! \param     dt                time step
    ...
    //------------------------
    virtual void lowMachSoundSpeed(double& /*machRef*/,
                                   const double& /*uL*/,
                                   double& /*cL*/,
                                   const double& /*uR*/ = Errors::defaultDouble,
                                   double& /*cR*/       = Tools::uselessDouble) const
    {
      Errors::errorMessage("lowMachSoundSpeed not available for required model");
    };
    ...
    {
      Errors::errorMessage("reverseProjectionMrfFlux not available for required model");
    };
    ...
    virtual void readCompactionParameters(tinyxml2::XMLElement* /*elementCompaction*/, std::string /*fileName*/, const int& /*k*/)
    {
      Errors::errorMessage("readCompactionParameters not available for required model");
    };

    //! \brief    Return if compaction is activated or not
    //! \param    k               phase number
    virtual bool compaction(const int& /*k*/) const
    {
      Errors::errorMessage("compaction not available for required model");
      return false;
    };

    //! \brief    Return the compaction reference density of phase k
    //! \param    k               phase number
    virtual const double& getDensityReference(const int& /*k*/) const
    {
      Errors::errorMessage("getDensityReference not available for required model");
    ...
    virtual double computeEnergyCompaction(const int& /*k*/, const double& /*alpha*/, const double& /*density*/, const double& /*lambda*/) const
    {
      Errors::errorMessage("computeEnergyCompaction not available for required model");
      return Errors::defaultDouble;
    };

    //! \brief  Compute the compaction pressure term including the derivative d kappa_k / d xi_k
    //! \param    k               phase number
    //! \param    alpha           volume fraction (\f$ \alpha \f$)
    //! \param    density         density (\f$ \rho \f$)
    //! \param    lambda          compaction variable (\f$ \lambda \f$)
    //!return    \f$ \frac{\partial \kappa_k}{\partial \xi_k} \f$ (compaction pressure)
    virtual double
    computeCompactionPressure_dkappadxi(const int& /*k*/, const double& /*alpha*/, const double& /*density*/, const double& /*lambda*/) const
    {
      Errors::errorMessage("computeCompactionPressure_dkappadxi not available for required model");
      return Errors::defaultDouble;
    };

    //! \brief  Compute the compaction pressure term including the derivative d kappa_k / d alpha_k
    //! \param    k               phase number
    //! \param    alpha           volume fraction (\f$ \alpha \f$)
    //! \param    density         density (\f$ \rho \f$)
    //! \param    lambda          compaction variable (\f$ \lambda \f$)
    //!return    \f$ \frac{\partial \kappa_k}{\partial \alpha_k} \f$ (compaction pressure)
    virtual double
    computeCompactionPressure_dkappadalpha(const int& /*k*/, const double& /*alpha*/, const double& /*density*/, const double& /*lambda*/) const
    {
      Errors::errorMessage("computeCompactionPressure_dkappadalpha not available for required model");
      return Errors::defaultDouble;
    };
    ...
    //! \param    f               compaction function f (\f$ f \f$)
    //!return    \f$ \dlambda \f$ (compaction plasticity)
    virtual double computeCompactionPlasticity(
      const int& /*k*/, const double& /*alpha*/, const double& /*density*/, const double& /*lambda*/, const double& /*pc*/, double& /*f*/) const
    {
      Errors::errorMessage("computeCompactionPlasticity not available for required model");
      return Errors::defaultDouble;
    };
    ...
    //! \param    fileName           string name of readed XML file
    //! \param    k                  phase number
    virtual void readSolidParameters(tinyxml2::XMLElement* /*elementSolid*/, std::string /*fileName*/, const int& /*k*/)
    {
      Errors::errorMessage("readSolidParameters not available for required model");
    };
    ...
    {
      Errors::errorMessage("getElasticParameterA not available for required model");
      return 0;
    };
    ...
    {
      Errors::errorMessage("getShearModulus not available for required model");
      return 0;
    };
    //! \brief    Return the chi modulus for each phase
    virtual const double* getChi() const
    {
      Errors::errorMessage("getChi not available for required model");
      return 0;
    }; //KS//NF
    ...
    {
      Errors::errorMessage("getElasticityLimit not available for required model");
      return 0;
    };
    ...
    virtual double computeElasticEnergy(const int& /*k*/, const Tensor& /*cobase*/) const
    {
      Errors::errorMessage("computeElasticEnergy not available for required model");
      return Errors::defaultDouble;
    };
    ...
    virtual void computeElasticEnergyAndStressTensor(const int& /*k*/,
                                                     const Tensor& /*cobase*/,
                                                     const double& /*pressure*/,
                                                     const double& /*density*/,
                                                     double& /*elasticEnergy*/,
                                                     Tensor& /*stressTensor*/) const
    {
      Errors::errorMessage("computeElasticEnergyAndStressTensor not available for required model");
    };
    ...
    virtual double computeSquareLongitudinalWaveSpeed(const int& /*k*/, const Phase& /*phase*/)
    {
      Errors::errorMessage("computeSquareLongitudinalWaveSpeed not available for required model");
      return Errors::defaultDouble;
    };
    ...
    {
      Errors::errorMessage("selectScalar not available for required model");
      return Errors::defaultDouble;
    };
    ...
    {
      Errors::errorMessage("getVelocity not available for required model");
      return Coord::defaultCoord;
    };
    virtual Coord& getVelocity(Cell* /*cell*/)
    {
      Errors::errorMessage("getVelocity not available for required model");
      return Coord::defaultCoordNonConst;
    };

    virtual const Coord& getVectorP(const Cell* /*cell*/) const
    {
      Errors::errorMessage("getVectorP not available for required model");
      return Coord::defaultCoord;
    };
    virtual Coord& getVectorP(Cell* /*cell*/)
    {
      Errors::errorMessage("getVectorP not available for required model");
      return Coord::defaultCoordNonConst;
    };
    ...
    {
      Errors::errorMessage("setSmoothCrossSection1d not available for required model");
    };
    virtual const bool& isSmoothCrossSection1d() const { return m_smoothCrossSection1d; };

    const bool& getLowMach() const { return m_lowMach; };
    void setLowMach(const bool& lowMach) { m_lowMach = lowMach; };
