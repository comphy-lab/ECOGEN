...
void FluxEulerHomogeneous::printFlux() const { std::cout << m_mass << " " << m_momentum.getX() << " " << m_energ << std::endl; }
...
void FluxEulerHomogeneous::setBufferFlux(Cell& cell) { static_cast<FluxEulerHomogeneous*>(fluxBuff)->buildCons(cell.getPhases(), cell.getMixture()); }
