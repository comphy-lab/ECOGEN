...
void APEConductivity::addQuantityAddPhys(Cell* cell) { cell->getVecQuantitiesAddPhys().push_back(new QAPConductivity(this)); }
...
void APEConductivity::solveFluxConductivityNonReflecting(const Coord& gradTLeft) const { this->solveFluxConductivityInner(gradTLeft, gradTLeft); }
