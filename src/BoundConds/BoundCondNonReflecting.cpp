...
void BoundCondNonReflecting::solveRiemannTransportBoundary(Cell& cellLeft) const { model->solveRiemannTransportIntern(cellLeft, cellLeft); }

//****************************************************************************
//******************************AMR Method***********************************
//****************************************************************************

void BoundCondNonReflecting::creerCellInterfaceChild() { m_cellInterfacesChildren.push_back(new BoundCondNonReflecting(*this, m_lvl + 1)); }
