...
class Face
{
  public:
    ...
    {
      Errors::errorMessage("initializeOthers not available for requested face");
    }
    virtual void setPos(const double& /*X*/, const double& /*Y*/, const double& /*Z*/)
    {
      Errors::errorMessage("setPos not available for requested face");
    };
    virtual void setNormal(const double& /*X*/, const double& /*Y*/, const double& /*Z*/)
    {
      Errors::errorMessage("setNormal not available for requested face");
    };
    virtual void setTangent(const double& /*X*/, const double& /*Y*/, const double& /*Z*/)
    {
      Errors::errorMessage("setTangent not available for requested face");
    };
    virtual void setBinormal(const double& /*X*/, const double& /*Y*/, const double& /*Z*/)
    {
      Errors::errorMessage("setBinormal not available for requested face");
    };
    virtual void setSize(const double& /*sizeX*/, const double& /*sizeY*/, const double& /*sizeZ*/)
    {
      Errors::errorMessage("setSize not available for requested face");
    };
    ...
    {
      Errors::errorMessage("getSizeX not available for requested face");
      return Errors::defaultDouble;
    };
    virtual const double& getSizeY()
    {
      Errors::errorMessage("getSizeY not available for requested face");
      return Errors::defaultDouble;
    };
    virtual const double& getSizeZ()
    {
      Errors::errorMessage("getSizeZ not available for requested face");
      return Errors::defaultDouble;
    };
    virtual const Coord& getSize()
    {
      Errors::errorMessage("getSize not available for requested face");
    ...
    {
      Errors::errorMessage("creerNouvelleFace not available for requested face");
      return 0;
    };
