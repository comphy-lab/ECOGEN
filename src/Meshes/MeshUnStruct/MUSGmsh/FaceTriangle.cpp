...
FaceTriangle::FaceTriangle(const int& numNode1, const int& numNode2, const int& numNode3, int tri) : FaceNS(NUMBERNODES)
{
...
void FaceTriangle::computeSurface(const Coord* nodes)
{
  ...
  double dp = 0.5 * (a + b + c);
  //AF//TODO//Look of possible to remove call to sqrt
