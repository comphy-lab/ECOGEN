...
{
  public:
    BoundCondInletTank(int numPhysique,
    ...
    int whoAmI() const override { return INLETTANK; };
    void printInfo() override;

    //For AMR method
    void creerCellInterfaceChild() override; /*!< Create a child cell interface (non initialize) */
