...
class QuantitiesAddPhys
{
  public:
    ...
    {
      Errors::errorMessage("computeQuantities not implemented for used quantities of additional physics");
    };
    ...
    {
      Errors::errorMessage("setGrad not implemented for used quantities of additional physics");
    };
    //! \brief     Get the additional-physic gradient
    //! \param     num                  number to determine the corresponding gradient
    virtual const Coord& getGrad(const int& /*num*/ = -1) const
    {
      Errors::errorMessage("getGrad not implemented for used quantities of additional physics");
    ...
    //! \param     grad                 transmitted gradient
    virtual void setGradTk(const int& /*phaseNum*/, const Coord& /*grad*/)
    {
      Errors::errorMessage("setGradTk not implemented for used quantities of additional physics");
    };
    //! \brief     Return the gradient of the velocity along the x-direction
    virtual Coord getGradU() const
    {
      Errors::errorMessage("getGradU not implemented for used quantities of additional physics");
      return 0;
    };
    //! \brief     Return the gradient of the velocity along the y-direction
    virtual Coord getGradV() const
    {
      Errors::errorMessage("getGradV not implemented for used quantities of additional physics");
      return 0;
    };
    //! \brief     Return the gradient of the velocity along the z-direction
    virtual Coord getGradW() const
    {
      Errors::errorMessage("getGradW not implemented for used quantities of additional physics");
      return 0;
    };
    //! \brief     Return the gradient of the phase temperature
    //! \param     phaseNum             number of the corresponding phase
    virtual const Coord& getGradTk(const int& /*phaseNum*/) const
    {
      Errors::errorMessage("getGradTk not implemented for used quantities of additional physics");
      return Coord::defaultCoord;
    };
