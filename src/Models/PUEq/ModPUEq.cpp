...
void ModPUEq::allocateCons(Flux** cons) { *cons = new FluxPUEq(numberPhases); }

//***********************************************************************

void ModPUEq::allocatePhase(Phase** phase) { *phase = new PhasePUEq; }

//***********************************************************************

void ModPUEq::allocateMixture(Mixture** mixture) { *mixture = new MixPUEq; }

//***********************************************************************

void ModPUEq::fulfillStateResume(Phase** phases, Mixture* mixture)
{
...
void ModPUEq::correctionEnergy(Cell* cell, Prim type) const { cell->correctionEnergy(type); }
