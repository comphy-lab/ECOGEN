...
Point(1) = {refX, refY, refZ, dx};

// External circle
Point(2) = {refX+rExt, refY, refZ, dx};
Point(3) = {refX, refY+rExt, refZ, dx};
Point(4) = {refX-rExt, refY, refZ, dx};
Point(5) = {refX, refY-rExt, refZ, dx};
...
// Internal circle
Point(6) = {refX+rInt, refY, refZ, dx};
Point(7) = {refX, refY+rInt, refZ, dx};
Point(8) = {refX-rInt, refY, refZ, dx};
Point(9) = {refX, refY-rInt, refZ, dx};
...
Physical Surface(fluidInt) = {2};
Physical Surface(fluidExt) = {1};
