...
BoundCondWallO2NS::BoundCondWallO2NS(int numPhysique, tinyxml2::XMLElement* element, std::string fileName) :
  BoundCondWall(numPhysique, element, fileName)
{}
...
void BoundCondWallO2NS::solveRiemann(double& dtMax,
