...
class BoundCondNonReflecting : public BoundCond
{
  public:
    ...
    ~BoundCondNonReflecting() override;
    ...
    int whoAmI() const override { return NONREFLECTING; };
...
extern BoundCondNonReflecting BoundCondDefaut;

#endif // BOUNDCONDNONREFLECTING_H
