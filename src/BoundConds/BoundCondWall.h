...
class BoundCondWall : public BoundCond
{
  ...
  protected:
    ...
    double m_imposedHeatQuantity; //!< Imposed heat quantity on the wall. Depending on input (m_heatCondition) could be imposed temperature
                                  //!< or flux density. This option requires conductivity additionnal physics to work
