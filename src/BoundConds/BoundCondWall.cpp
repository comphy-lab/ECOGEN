...
BoundCondWall::BoundCondWall(int numPhysique, XMLElement* element, std::string fileName) :
  BoundCond(numPhysique), m_heatCondition(TypeBCHeat::ADIABATIC), m_imposedHeatQuantity(0.), m_isMRFWall(false), m_omegaWall(0.)
{
...
void BoundCondWall::createBoundary(TypeMeshContainer<CellInterface*>& cellInterfaces) { cellInterfaces.push_back(new BoundCondWall(*(this))); }
...
void BoundCondWall::solveRiemannTransportBoundary(Cell& /*cellLeft*/) const { model->solveRiemannTransportWall(); }

//****************************************************************************
//******************************AMR Method***********************************
//****************************************************************************

void BoundCondWall::creerCellInterfaceChild() { m_cellInterfacesChildren.push_back(new BoundCondWall(*this, m_lvl + 1)); }
